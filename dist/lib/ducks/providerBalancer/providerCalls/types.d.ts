...
export declare type ProviderCallState = ISuccessfulProviderCall | IPendingProviderCall | IFailedProviderCall;
export declare type ProviderCallsState = StrIdx<ProviderCallState>;
export declare enum PROVIDER_CALL {
...
export declare type ProviderCallWithPid = IProviderCall & {
    providerId: string;
};
...
export interface IProviderCallTimeout {
    ...
    payload: {
        error: Error;
        providerCall: ProviderCallWithPid;
    };
}
...
export declare type ProviderCallAction = IProviderCallRequested | IProviderCallTimeout | IProviderCallFailed | IProviderCallSucceeded | IProviderCallFlushed;
