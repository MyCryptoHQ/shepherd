...
export declare enum PROVIDER_STATS {
...
export declare type ProcessedProvider = IProviderStatsAdded['payload'];
...
export declare type ProviderStatsAction = IProviderStatsOnline | IProviderStatsOffline | IProviderStatsAdded | IProviderStatsRemoved;
