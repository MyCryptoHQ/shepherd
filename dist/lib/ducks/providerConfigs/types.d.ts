...
export declare enum PROVIDER_CONFIG {
...
export interface IProviderConfig {
     ...
     */
    supportedMethods: {
        [rpcMethod in AllProviderMethods]: boolean;
    };
    /**
...
export interface IChangeProviderConfig {
    ...
    payload: {
        id: string;
        config: DeepPartial<IProviderConfig>;
    };
}
...
export declare type ProviderConfigAction = IAddProviderConfig | IChangeProviderConfig | IRemoveProviderConfig;
