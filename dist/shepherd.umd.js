(function (global, factory) {
    ...
    var URLSearchParams__default = /*#__PURE__*/_interopDefaultLegacy(URLSearchParams);
    ...
    ***************************************************************************** */
    ...
    const handleValues = (input) => {
        if (typeof input === 'string') {
            return input.startsWith('0x')
                ? new BN__default['default'](stripHexPrefix(input), 16)
                : new BN__default['default'](input);
        }
        if (typeof input === 'number') {
            return new BN__default['default'](input);
        }
        if (BN__default['default'].isBN(input)) {
            return input;
        }
        else {
    ...
    class MyCryptoCustomProvider extends RPCProvider {
        constructor(config) {
            ...
            if (config.auth) {
                ...
                headers.Authorization = `Basic ${btoa__default['default'](`${username}:${password}`)}`;
            }
    ...
    class EtherscanClient extends RPCClient {
        ...
        encodeRequest(request) {
            const encoded = new URLSearchParams__default['default']();
